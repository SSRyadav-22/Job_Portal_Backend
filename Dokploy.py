...
API_URL = "http://65.2.147.225:3000/api/project.all"
api_key = "hhbrDPDBbTkDOGbeMmqDhpbEanPxhRWrybnbndBPNyHBPLvQBjTHkJPJxjKvdegI"
app_name = "jobportal-jobportalfrontend-8ovtyf"
